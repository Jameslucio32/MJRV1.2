  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <!-- Navigation -->
        <img src="assets/img/panel.png" width="200" height="180" >
        <img src="assets/img/encoder.gif" width="200" height="150" >
        <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../messaging/login.php">
              <i class="fas fa-users text-primary"></i> Customers Messages
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../scanner/index.php" target="_blank">
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="payments_reports.php">
              <i class="fas fa-funnel-dollar"></i> Sales Report
            </a>
          </li>
          <?php
