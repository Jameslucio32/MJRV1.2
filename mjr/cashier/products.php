                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Stock</th> <!-- New Stock Column -->
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    while ($prod = $res->fetch_object()) {
                                        ...
                                        $isLowStock = $prod->prod_stock < $lowStockThreshold;
                                    ?>
                                        <tr class="<?php echo $isLowStock ? 'table-warning' : ''; ?>"> <!-- Highlight low stock rows -->
                                            ...
                                            <td><?php echo $prod->prod_stock; ?></td> <!-- Display Stock Quantity -->
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
