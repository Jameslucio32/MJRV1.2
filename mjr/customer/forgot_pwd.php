...
if (isset($_POST['request_otp'])) {
    if (!filter_var($_POST['reset_email'], FILTER_VALIDATE_EMAIL)) {
        ...
        $checkEmail = mysqli_query($mysqli, "SELECT `customer_email` FROM `rpos_customers` WHERE `customer_email` = '$reset_email'") or exit(mysqli_error($mysqli));
...
if (isset($_POST['confirm_otp'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $update_query = "UPDATE rpos_customers SET password = ? WHERE customer_email = ?";
                  ...
                  <form method="post" role="form">
                    ...
                    <div class="form-group mb-3">
                      <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" required name="new_password" id="new_password" placeholder="New Password" type="password">
