  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt='Image placeholder' src='../admin/assets/img/brand/HEADER.png'>
              </span>
            </div>
          </a>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard.php">
                <img src="../admin/assets/img/brand/HEADER.png">
              </a>
            </div>
        ...
        <!-- Navigation -->
        <img src="../admin/assets/img/brand/customerpanel.png" width="200" height="180" >
        <img src="../admin/assets/img/brand/customer.gif" width="200" height="150" >
        <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="../messaging/login.php">
              <i class="fas fa-users text-primary"></i> Customer Service
            </a>
          </li>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="refundreq.php">
              <i class="fas fa-shopping-basket"></i> My Refund
            </a>
          </li>
          <li class="nav-item">
